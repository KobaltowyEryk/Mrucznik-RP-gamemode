...
//======================================================================
       ...
       //wejscie do vinyl
        ...
        //san news biura
        else if(PlayerToPoint(1.0, playerid, 286.0645,-1602.0117,134.4274)) //wejście dyraktor
        {
            SetPlayerPos(playerid, 285.8782,-1604.2446,134.4756); 
            return 1;
        }
        else if(PlayerToPoint(1.0, playerid, 285.8782,-1604.2446,134.4756)) ////wyjście dyraktor
        {
            SetPlayerPos(playerid, 286.0645,-1602.0117,134.4274); 
            posDrzwiSN[playerid] = 0; 
            return 1;
        }
        else if(PlayerToPoint(1.0, playerid, 298.0779,-1603.7250,134.4482)) //wejscie v-dyrektor
        {
            SetPlayerPos(playerid, 297.9890,-1605.9541,134.4645); 
            return 1;
        }
        else if(PlayerToPoint(1.0, playerid, 297.9890,-1605.9541,134.4645)) //wyjście v-dyrektor
        {
